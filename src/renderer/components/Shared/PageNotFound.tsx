...
const PageNotFound: React.FC = () => {
  ...
  // ----------------------------------------------------------------------
  // 🏨 HOTEL QUICK LINKS (static, no permissions)
  // ----------------------------------------------------------------------
  const quickLinks = [
        ...
        <div className="mt-6 text-center">
          ...
          >
            ...
            <span
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              HotelBookingManagement Lite • v{version || "0.0.0"} • {new Date().getFullYear()}
            </span>
          </div>
        </div>
      </div>
