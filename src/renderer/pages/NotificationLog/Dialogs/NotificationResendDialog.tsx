...
export const NotificationResendDialog: React.FC<NotificationRetryDialogProps> = ({
  id,
  isOpen,
  onClose,
  onConfirm,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="bg-[var(--card-bg)] rounded-xl border border-[var(--border-color)]/20 w-full max-w-md p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-[var(--text-primary)]">Resend Notification</h3>
        </div>
        <p className="text-[var(--text-secondary)] mb-6">
          Are you sure you want to resend this notification (ID: #{id})?
        </p>
