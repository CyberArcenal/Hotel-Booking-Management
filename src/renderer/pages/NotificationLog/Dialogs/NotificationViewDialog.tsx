          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                {log.booking?.guest?.fullName && (
                  <p className="text-xs text-[var(--text-secondary)]">{log.booking.guest.fullName}</p>
                )}
              </div>
            </div>
            {log.booking && (
              <div className="flex items-start gap-3">
                <Hash className="w-4 h-4 text-[var(--text-tertiary)] mt-0.5" />
                <div>
                  <p className="text-xs text-[var(--text-tertiary)] uppercase">Booking</p>
                  <p className="text-[var(--text-primary)]">#{log.booking.id}</p>
                  {log.booking.checkInDate && (
                    <p className="text-xs text-[var(--text-secondary)]">
                      {log.booking.checkInDate} → {log.booking.checkOutDate}
                    </p>
                  )}
                </div>
              </div>
