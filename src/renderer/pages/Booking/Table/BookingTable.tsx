...
const BookingPage: React.FC = () => {
  ...
  const handleView = (id: number) => navigate(`/bookings/${id}`);
  const handleEdit = (id: number) => navigate(`/bookings/${id}/edit`);
  ...
  const handleInvoice = (id: number) => navigate(`/bookings/${id}/invoice`);
