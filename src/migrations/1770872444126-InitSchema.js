 ...
 */
module.exports = class InitSchema1770872444126 {
    name = 'InitSchema1770872444126'

    /**
     * @param {QueryRunner} queryRunner
     */
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "temporary_bookings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "checkInDate" date NOT NULL, "checkOutDate" date NOT NULL, "numberOfGuests" integer NOT NULL DEFAULT (1), "totalPrice" float(10,2) NOT NULL, "status" varchar NOT NULL DEFAULT ('confirmed'), "specialRequests" text, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "roomId" integer, "guestId" integer, "paymentStatus" varchar CHECK( "paymentStatus" IN ('pending','paid','failed') ) NOT NULL DEFAULT ('pending'), CONSTRAINT "FK_28306518087b40a95df05a43624" FOREIGN KEY ("guestId") REFERENCES "guests" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_0172b36e4e054d6ebb819d58efb" FOREIGN KEY ("roomId") REFERENCES "rooms" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
