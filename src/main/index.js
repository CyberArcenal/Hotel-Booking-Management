...
// @ts-check
/**
 * @file Main entry point for Hotel Booking Management & Attendance Management System
 * @version 0.0.0
 * @author CyberArcenal
...
const APP_CONFIG = {
  ...
  appName: "Hotel Booking Management",
  ...
  if (writeToFile && !APP_CONFIG.isDev) {
    try {
      ...
      const logFile = path.join(
        logDir,
        `hotelBooking-${new Date().toISOString().split("T")[0]}.log`,
      );
